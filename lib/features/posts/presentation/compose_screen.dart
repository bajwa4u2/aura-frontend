...
List<String> _listOfString(dynamic v, {int take = 3}) {
  ...
  CompositionSurface get _compositionSurface {
    final explicit = CompositionSurfaceX.tryParse(widget.surface);
  ...
  Future<void> _publish() async {
    ...
    if (_compositionReview == null) {
      final review = await _runCompositionReview(fromPublish: true);
      if (review == null) return;
      if (review.findings.isNotEmpty) return;
    }
