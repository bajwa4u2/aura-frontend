...
final followStateProvider =
    FutureProvider.family<String, String>((ref, handle) async {
  final repo = ref.watch(profileRepositoryProvider);
                                  ...
                                  InkWell(
                                    onTap: () {
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (_) =>
                                              _ProfileConnectionsScreen(
                                            title: 'Followers',
                                            handle: handle,
                                            kind:
                                                _ConnectionsKind.followers,
                                          ),
                                        ),
                                      );
                                    },
