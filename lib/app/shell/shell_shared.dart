  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // where the company site, Orchestrate and Colophon all put it.
...
///
/// Not a new invention. The company site, Orchestrate and Colophon all
...
///
///   * THE FIELD is Aura's, not Colophon's teal or Orchestrate's slate.
