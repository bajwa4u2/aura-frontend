...
'  }' \
'' \
'  # Flutter SPA fallback. Per-route directory indexes generated by' \
'  # tool/web/generate_route_metadata.dart are picked up before this' \
'  # fallback resolves to /index.html.' \
'  location / {' \
